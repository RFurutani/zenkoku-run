...
// 伝える内容が無い版はキーを置かない（まだ見ていない範囲から新しい順に拾うため、T-68）。
const WHATS_NEW = {
  "1.8.0": {
    title: "v1.8.0 で増えたこと",
    body: [
  ...
  // 1.13.1・1.14.0には、利用者に伝える新しい内容が無いためキーを置かない。
  // 以前は完全一致でしか引けず1.13.0の文言を書き写していたが、T-68で範囲表示に
  // 改めたため、見ていない版の中から1.13.0が拾われる（書き写しは不要になった）。
};
