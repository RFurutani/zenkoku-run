...
const SECTIONS = [
  {
    ...
    blocks: [
      {
        type: "p",
        text: "管理者が一人で作って運用している、無償の個人アプリです。会社でもサービスでもありません。管理者が続けられなくなれば、そこで終わります。動かないことがあり、直せる保証はありません。",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "p", text: "不適切と判断した写真は、管理者が予告なく削除することがあります。" },
    ],
  },
  {
  ...
  {
    heading: "メンバーの追加",
    blocks: [{ type: "p", text: "メンバーを増やすかどうかは、管理者が判断します。チームには人数の上限があります。" }],
  },
  {
    heading: "やめたいとき",
    blocks: [
      ...
      { type: "p", text: "完全に削除してほしい場合は、ご相談ください。" },
    ],
  },
  {
    heading: "サポート",
  ...
  {
    heading: "参考：いま分かっている不便な点",
    blocks: [
      { type: "p", text: "ここから下は規約ではなく、現状についての参考情報です。" },
      {
        type: "ul",
        items: [
          "1時間ほどでログアウトします",
